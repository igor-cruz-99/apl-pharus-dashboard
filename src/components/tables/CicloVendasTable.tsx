              ...
              {filtradas.length === 0 ? (
                ...
                filtradas.map((l, i) => (
                  <tr key={`${l.nome}-${l.data_venda}-${i}`} className="border-t border-line/60">
                    ...
                    <td className="numero px-3 py-2 text-right whitespace-nowrap text-laranja-texto">
                      {dias(l.dias_cria_agen)}
                    </td>
                    <td className="numero px-3 py-2 text-right whitespace-nowrap text-laranja-texto">
                      {dias(l.dias_agen_venda)}
                    </td>
                    <td className="numero px-3 py-2 text-right whitespace-nowrap font-semibold text-laranja-texto">
