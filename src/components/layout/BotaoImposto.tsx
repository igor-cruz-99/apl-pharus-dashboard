 ...
 *
 * Fica em ocre, não no laranja da marca, de propósito: o laranja marca o que
...
export function BotaoImposto({
  ...
  // ⚠️ Nada de `Math.round` aqui: a taxa tem casas decimais (12,15%) e o
  // arredondamento mostraria "12%" — um número que não é o que a conta usa.
  // O `toLocaleString` também resolve o 12.149999… que sai de 0.1215 * 100.
  const pct = `${(TAXA_IMPOSTO_META * 100).toLocaleString('pt-BR', {
