...
/**
 * Imposto da Meta — 12,15% sobre o investimento.
 *
 * O que o banco devolve é o gasto que a Meta cobra na plataforma. O custo real
 * da empresa é 12,15% maior. Ligado, o painel passa a mostrar o custo real; e como
 ...
 */
export const TAXA_IMPOSTO_META = 0.1215
...
// ---------------------------------------------------------------------------
// Campos que sobem 12,15%. Um por contrato de dados, na mesma ordem de types/.
// ---------------------------------------------------------------------------
