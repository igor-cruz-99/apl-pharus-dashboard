 ...
 */
// Tons escuros: a escala pinta TEXTO sobre o creme, e os pastéis sumiriam.
const RUIM = [0xb4, 0x23, 0x18]
const MEIO = [0x9a, 0x67, 0x00]
const BOM = [0x15, 0x80, 0x3d]
...
export function classesBadge(s: Situacao): string {
  switch (s) {
    ...
    default:
      return 'bg-laranja/10 text-laranja-texto border-laranja/25'
  }
}
